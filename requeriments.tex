...
En aquest capítol es descriurán els requeriments més tècnics del projecte ja que els requeriments funcionals  deriven de les regles  de la botifarra, explicades en el capítol \ref{chap:botifarra}.

Es vol construir un sistema que sigui capàs de allotjar partides de la botifarra en línia a través d'un navegador. S'ha elegit l'arquitèctura en forma de servei web per tal d'evitar que l'usuari haigi de realitzar la instal·lació de cap tipus de software, fàcilitant l'accès al sistema. Aquesta decisió implica estructurar el sistema en dos grans blocs: el servidor web i els diferents clients. El primer s'encarrega de proporcionar els mecanismes suficients per comunicar les accions dels usuaris, i els segons s'encarreguen de mostrar la informació que reben del servidor d'una forma amigable. 
